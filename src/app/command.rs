...
//         }
//
//         self.user_input.drain(start_idx..byte_idx);
...
//
//
// // Actions for normal keystrokes.
// impl  CommandLine {
//
//     fn insert_char(&mut self, ch: char) {
//         self.user_input.insert(self.cursor.byte_idx(), ch);
//         self.cursor.move_right(ch);
//     }
//
//     fn remove_char(&mut self, byte_idx: usize) {
//
//         if byte_idx == self.user_input.len() {
